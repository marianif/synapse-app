...
for (const file of phaseFiles) {
  ...
  if (src !== orig) {
    ...
    if (!/migrated to v2 tokens — phase 3/.test(src)) {
      src = "// migrated to v2 tokens — phase 3\n" + src;
    }
  }
...
const mdPath = path.join(rootDir, ".impeccable/generated/phase-3-rewrite-report.md");
