...
export const CREATE_DIARY_TABLE = `
  CREATE TABLE IF NOT EXISTS diary_entries (
    ...
    media TEXT,
    -- Whether this note is bookmarked — a kept/pinned flag for the diary.
    -- SQLite has no boolean; 0/1, same convention as tasks.done and
    -- projects.is_featured. Set with the bookmark toggle in the note footer.
